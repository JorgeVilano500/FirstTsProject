...
function App() {
  ...
  }) // random word will always be loaded when it is rendered
  const [guessedLetters, setGuessedLetters]= useState<string[]>([])// this will be a string in the state explicityly
